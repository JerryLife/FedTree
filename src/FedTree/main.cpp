...
//    }
    ...
    if(fl_param.mode == "hybrid"){
        ...
        if (fl_param.deltaboost_param.enable_delta) {
            ...
            parser.save_model("cache/breast.model", fl_param.deltaboost_param, deltaboost->trees, dataset);
            parser.load_model("cache/breast.model", fl_param.deltaboost_param, deltaboost->trees, dataset);
